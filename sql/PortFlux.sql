...
------------------------------------------------------------
-- 11) ORDERS & ORDER_ITEMS (샘플 주문 데이터)
------------------------------------------------------------
-- 샘플 주문은 실제 사용 시 자동 생성되므로 생략
...
-- 11) ORDERS 테이블 전체 조회
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT '11. ORDERS 테이블 전체 데이터' AS INFO FROM DUAL;
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT * FROM ORDERS ORDER BY id;

-- 12) ORDER_ITEMS 테이블 전체 조회
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT '12. ORDER_ITEMS 테이블 전체 데이터' AS INFO FROM DUAL;
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT * FROM ORDER_ITEMS ORDER BY id;

-- 13) POST_LIKE 테이블 전체 조회
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT '13. POST_LIKE 테이블 전체 데이터' AS INFO FROM DUAL;
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT * FROM POST_LIKE ORDER BY like_id;

-- 14) COMMENT_LIKE 테이블 전체 조회
SELECT '========================================' AS DIVIDER FROM DUAL;
SELECT '14. COMMENT_LIKE 테이블 전체 데이터' AS INFO FROM DUAL;
SELECT '========================================' AS DIVIDER FROM DUAL;
