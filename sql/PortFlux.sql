-- ============================================================
-- PortFlux 데이터베이스 스키마 및 샘플 데이터 (12차 수정본)
-- 수정사항: 관리자/일반유저/기업 비밀번호 BCrypt 암호화 적용
-- ============================================================
...
VALUES ('user001', '$2a$10$N9qo8uLOickgx2ZMRZoMyOeQp6c8cT9tKQ0.y6I.E2xXLzC4M4zXe', '김철수', '010-1234-5678', 'kimcs@email.com', '철수짱', 1);

INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname, user_level)
VALUES ('user002', '$2a$10$N9qo8uLOickgx2ZMRZoMyOeQp6c8cT9tKQ0.y6I.E2xXLzC4M4zXe', '이영희', '010-9876-5432', 'leeyh@email.com', '영희네', 2);

------------------------------------------------------------
-- 1-1) ADMIN 관리자 계정
-- 아이디: admin / 비밀번호: admin123!
-- BCrypt 해시: $2a$10$8K1p/a0dR1xqM8K3hYl5Q.HqGz6z8ZLm1oQ3PcYvKcF6w8x9y0z1W
------------------------------------------------------------
INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname)
VALUES ('admin', '$2a$10$PpFY4WiBz.qL/Prd9OE44uDR5S2rmrSckEe9EeaHc7lrDgRF42ljO', '관리자', '010-0000-0000', 'admin@portflux.com', '관리자');

INSERT INTO ADMIN_ACCOUNT (user_num, admin_id, admin_password, admin_name)
SELECT user_num, 'admin', '$2a$10$PpFY4WiBz.qL/Prd9OE44uDR5S2rmrSckEe9EeaHc7lrDgRF42ljO', '관리자'
FROM USERS 
WHERE user_id = 'admin';

------------------------------------------------------------
-- 2) COMPANY (기업 사용자 2개)
-- 비밀번호: comp123! → BCrypt 해시
------------------------------------------------------------
INSERT INTO COMPANY (company_id, company_password, company_name, company_phone, company_email, business_number)
VALUES ('company001', '$2a$10$rBV2JkT5mS8mN7F1eK9xLuZqWpYnXaE3G6cR4vH8tJ0yM2iU5o3Wa', '테크스타트업', '02-1234-5678', 'contact@techstartup.com', '123-45-67890');

INSERT INTO COMPANY (company_id, company_password, company_name, company_phone, company_email, business_number)
VALUES ('company002', '$2a$10$rBV2JkT5mS8mN7F1eK9xLuZqWpYnXaE3G6cR4vH8tJ0yM2iU5o3Wa', '디자인에이전시', '02-9876-5432', 'hello@designagency.com', '987-65-43210');
...
------------------------------------------------------------
-- 5~10) SAVE, FOLLOWS, CHAT, CART 샘플
------------------------------------------------------------
