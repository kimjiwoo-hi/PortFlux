...
INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname, user_level)
VALUES ('user002', 'password456!', '이영희', '010-9876-5432', 'leeyh@email.com', '영희짱', 2);

INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname, user_level)
VALUES ('user003', 'password789!', '박민수', '010-5555-6666', 'parkms@email.com', '민수dev', 1);

INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname, user_level)
VALUES ('user004', 'password321!', '최수진', '010-7777-8888', 'choisj@email.com', '수진코딩', 2);
...
-- 3) POST - lookup은 lookup_Dummy_Data.sql에서 관리 (POST_ID 10-26)
-- 여기서는 free(2001~), notice(3001~), job(1001~) 관리

-- ============================================================
-- 커뮤니티 더미데이터 - free (POST_ID 2001~)
-- ============================================================
INSERT INTO POST (post_id, board_type, user_num, title, content, view_cnt)
VALUES (2001, 'free', 3, '오라클 DB 설치 중 에러 해결 방법',
        '오라클 19c 설치하다가 ORA-12154 에러가 발생했어요. 해결 방법 공유합니다.', 85);

INSERT INTO POST (post_id, board_type, user_num, title, content, view_cnt)
VALUES (2002, 'free', 4, 'Spring Boot 프로젝트 구조 추천해주세요',
        '처음으로 Spring Boot로 큰 프로젝트를 시작하는데요. 패키지 구조 조언 부탁드립니다.', 120);

-- ============================================================
-- 공지사항 - notice (POST_ID 3001~)
-- ============================================================

-- [공지사항 2개] - 관리자(user_num=5)가 작성
INSERT INTO POST (post_id, board_type, user_num, title, content, view_cnt)
...
-- ============================================================
-- 커뮤니티 더미데이터 - free 계속 (POST_ID 2003~)
-- ============================================================
...
-- 4) POST_COMMENT - lookup 게시글에 대한 댓글 (기존 유지)
...
INSERT INTO POST_COMMENT (user_num, post_id, comment_content)
VALUES (3, 2, 'React 템플릿 잘 쓰겠습니다! 구조가 깔끔하네요.');

INSERT INTO POST_COMMENT (user_num, post_id, comment_content)
VALUES (4, 3, 'Spring Boot API 템플릿 질문있어요! JWT 설정 어디서 바꾸나요?');

INSERT INTO POST_COMMENT (user_num, post_id, comment_content)
VALUES (3, 3, 'application.yml에서 jwt.secret 부분 수정하시면 됩니다~');
...
-- 5) POST_SAVE - lookup 게시글 저장 (기존 유지)
INSERT INTO POST_SAVE (user_num, post_id) VALUES (1, 2);
INSERT INTO POST_SAVE (user_num, post_id) VALUES (2, 1);
INSERT INTO POST_SAVE (user_num, post_id) VALUES (3, 1);
INSERT INTO POST_SAVE (user_num, post_id) VALUES (4, 2);
...
INSERT INTO CART (user_num, post_id) VALUES (3, 4);
INSERT INTO CART (user_num, post_id) VALUES (4, 3);
...
-- 13) POST_LIKE - lookup 게시글 좋아요 (기존 유지)
INSERT INTO POST_LIKE (user_num, post_id) VALUES (1, 1);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (2, 1);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (3, 1);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (4, 2);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (3, 4);

-- 커뮤니티 게시글(2001~) 좋아요
INSERT INTO POST_LIKE (user_num, post_id) VALUES (1, 2001);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (2, 2001);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (4, 2007);
INSERT INTO POST_LIKE (user_num, post_id) VALUES (3, 2009);
...
-- 14) COMMENT_LIKE - lookup 댓글 좋아요 (기존 유지)
INSERT INTO COMMENT_LIKE (user_num, comment_id) VALUES (2, 1);
INSERT INTO COMMENT_LIKE (user_num, comment_id) VALUES (3, 2);
INSERT INTO COMMENT_LIKE (user_num, comment_id) VALUES (4, 3);
