...
------------------------------------------------------------
-- 6) POST_SAVE 테이블 (일반 사용자 + 기업 회원 북마크 지원)
------------------------------------------------------------
...
-- POST_SAVE 중복 방지 유니크 인덱스 (함수 기반)
-- user_num이 있는 경우의 유니크 제약
...
INSERT INTO USERS (user_id, user_password, user_name, user_phone, user_email, user_nickname, user_level)
VALUES ('asdasd', '$2a$10$Z5vnwKlbnX9k532EoJztUetGYFKs73hSEeL2NPVFX8bCCXJZUGWdm', 'ASD이름', '01012345678', 'asd@naver.com', 'ASD닉네임', 1);
...
-- 3) POST
-- 둘러보기 게시글은 lookup_Dummy_Data.sql에서 POST_ID 10-26으로 관리
...
-- 4) POST_COMMENT
-- 둘러보기 게시글(post_id 10번대)에 대한 댓글
INSERT INTO POST_COMMENT (user_num, post_id, comment_content)
VALUES (2, 10, '자료 정말 유익하네요! 다운로드해서 공부하겠습니다.');

INSERT INTO POST_COMMENT (user_num, post_id, comment_content)
VALUES (1, 10, '감사합니다! 많은 도움이 되셨으면 좋겠어요~');
...
INSERT INTO CHAT_MESSAGES (room_id, user_num, sender_num, content) VALUES (2, 4, 3, '포트폴리오 잘 봤어요!');
INSERT INTO CHAT_MESSAGES (room_id, user_num, sender_num, content) VALUES (3, 3, 1, 'React 글 정말 유익하게 봤습니다!');
...
VALUES (1, 10, '웹 프로그래밍 팀 프로젝트', 3500, 1);

INSERT INTO ORDER_ITEMS (order_id, product_id, product_name, unit_price, qty)
VALUES (1, 13, '심플한 회색 PPT', 2000, 1);
...
-- ============================================================
-- 채용공고 더미 데이터 (실제 서비스 시연용)
-- POST_ID 1000번대 사용하여 둘러보기/커뮤니티와 충돌 방지
-- ============================================================
...
INSERT INTO POST (
    ...
    1001, 'job', 1, '[네이버] 시니어 백엔드 개발자 (Java/Spring)',
...
INSERT INTO POST (
    ...
    1002, 'job', 2, '[카카오뱅크] 프론트엔드 개발자 (React/TypeScript)',
...
INSERT INTO POST (
    ...
    1003, 'job', 3, '[우아한형제들] 모바일 앱 개발자 (Android/iOS)',
...
INSERT INTO POST (
    ...
    1004, 'job', 4, '[삼성전자] UI/UX 디자이너 (신입/경력)',
...
INSERT INTO POST (
    ...
    1005, 'job', 5, '[현대자동차] 제품 디자이너 (Industrial Design)',
...
INSERT INTO POST (
    ...
    1006, 'job', 6, '[CJ ENM] 콘텐츠 마케터 (신입/경력)',
...
INSERT INTO POST (
    ...
    1011, 'job', 11, '[SK하이닉스] 반도체 공정 엔지니어',
...
INSERT INTO POST (
    ...
    1015, 'job', 15, '[토스] 데이터 분석가 (Data Analyst)',
...
INSERT INTO POST (
    ...
    1019, 'job', 19, '[파라다이스호텔] 프런트 데스크 (신입)',
