...
import "../pages/BoardJobEditPage.css";
  ...
  useEffect(() => {
    const fetchJobData = async () => {
      try {
        ...
        // 날짜 포맷 변환 (YYYY-MM-DD)
        const deadlineDate = data.jobDeadline
          ? new Date(data.jobDeadline).toISOString().split("T")[0]
          : "";
        ...
        setFormData({
          ...
          jobCareerType: data.jobCareerType || [],
          jobCareerYears: data.jobCareerYears || [],
          jobEducation: data.jobEducation || "",
          jobEducationExclude: data.jobEducationExclude || false,
          jobSalaryMin: data.jobSalaryMin || "",
          jobSalaryMax: data.jobSalaryMax || "",
          jobDeadline: deadlineDate,
          jobIndustries: data.jobIndustries || [],
          jobCompanyTypes: data.jobCompanyTypes || [],
          jobWorkTypes: data.jobWorkTypes || [],
          jobWorkDays: data.jobWorkDays || [],
        });
      } catch (error) {
